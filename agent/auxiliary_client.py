...
_FAST_MODEL_TASKS: frozenset = frozenset({"title_generation", "ideation_workbench"})
...
def _refresh_copilot_credentials() -> bool:
    from hermes_cli.copilot_auth import evict_cached_exchanged_token, get_copilot_api_token, resolve_copilot_token
    ...
    return bool(str(api_token or "").strip()) and api_token != raw_token
...
def resolve_provider_client(
    ...
    from hermes_cli.config import load_config
    from hermes_cli.provider_policy import configured_allowed_providers, require_provider_allowed
