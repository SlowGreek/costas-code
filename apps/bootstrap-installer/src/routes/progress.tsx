...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Catalyst' : 'Setting up Catalyst'

  const description = isUpdate
    ? 'Catalyst is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Catalyst installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
