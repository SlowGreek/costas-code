...
export const en: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      intro:
        'Catalyst starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Catalyst backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
