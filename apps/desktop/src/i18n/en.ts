...
export const en: Translations = {
  ...
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Catalyst and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Catalyst.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Catalyst. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Catalyst',
    continue: 'Continue in Catalyst',
  ...
  boot: {
    ...
    errors: {
      backgroundExited: 'Catalyst background process exited.',
      backgroundExitedDuringStartup: 'Catalyst background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Catalyst backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Catalyst',
    ...
    native: {
      ...
      inputBody: 'Catalyst is waiting for your response.',
      turnDoneTitle: 'Catalyst finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Catalyst defaults?',
    ...
    plugins: {
      ...
      blurb:
        'UI extensions loaded into this app — bundled with the build, or dropped into the desktop-plugins folder (including ones Catalyst writes). Disabling unloads a plugin live and survives restarts.',
      count: n => `${n} installed`,
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Catalyst backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Catalyst is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Catalyst asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Catalyst was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Catalyst follow your system setting.',
      ...
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Catalyst when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Catalyst walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Catalyst is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Catalyst, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Catalyst runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Catalyst only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Catalyst',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
    ...
    config: {
      ...
      loading: 'Loading Catalyst configuration...',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Catalyst gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Catalyst backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Catalyst backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Catalyst backend.',
      ...
      restartingMessage: 'Catalyst will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Catalyst ${version}` : ''}`,
      ...
      sshDesc:
        'Catalyst is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Catalyst runs ssh non-interactively.',
      sshErrHostKey:
    ...
    model: {
      ...
      tasks: {
        ...
        goal_judge: { label: 'Goal judge', hint: '/goal verdicts' },
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Catalyst starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Catalyst ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Catalyst runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Catalyst at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Catalyst browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Catalyst builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Catalyst to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Catalyst to generate pets.',
      backgroundHint: 'You can close this — Catalyst will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Catalyst desktop' },
    ...
    hermesActiveSessions: (version, count) => `Catalyst ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Catalyst environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Catalyst will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Catalyst backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Catalyst. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Catalyst...',
    placeholderReconnecting: 'Reconnecting to Catalyst…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Catalyst a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Catalyst will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Catalyst to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Catalyst…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Catalyst…',
    ...
    unsupportedMessage: 'This version of Catalyst can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Catalyst is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Catalyst backend is ready to install.',
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Catalyst desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Catalyst updater takes over in its own window and reopens Catalyst automatically when it’s done. Please don’t reopen Catalyst yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Catalyst reconnects automatically when it’s back.',
  ...
  install: {
    ...
    oneTimeTitle: 'Catalyst needs a one-time install',
    ...
    settingUpTitle: 'Setting up Catalyst',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Catalyst CLI or desktop instance is running. Stop any running Catalyst instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Catalyst",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Catalyst is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Catalyst…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Catalyst',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Catalyst connects automatically',
    ...
    authorizeThere: 'Authorize Catalyst there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Catalyst there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Catalyst inference gateway status',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Catalyst will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Catalyst is restarting...',
      askRestart: 'Ask Catalyst to restart the server',
      lookingRestart: taskId => `Catalyst is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Catalyst is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Catalyst to open a page.',
      finishedRestarting: message => `Catalyst finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Catalyst could not restart the server.',
      stillWorking:
        'Catalyst is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Catalyst is loading a response',
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Catalyst won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Catalyst needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Catalyst needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Catalyst to use Save Image.',
    restartToSaveImages: 'Restart Catalyst to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Catalyst loads when the work calls for them.'
      },
      messaging: {
        title: 'Catalyst away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Catalyst made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Catalyst — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
