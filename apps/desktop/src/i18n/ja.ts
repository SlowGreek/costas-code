...
export const ja = defineLocale({
  ...
  updates: {
    ...
    applyingBodyBackend: 'リモートバックエンドが更新を適用して再起動します。復帰すると Catalyst が自動的に再接続します。',
  ...
  install: {
    ...
    installLocalDesc: 'Catalyst をダウンロードし、Python 環境を作成して、このコンピューターでバックエンドを実行します。',
    localStartUnavailable:
      'ローカルインストールを開始できません。Catalyst を再起動して、もう一度お試しください。',
