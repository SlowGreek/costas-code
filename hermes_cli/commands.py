...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("update", "Update Catalyst to the latest version", "Info",
               busy_policy="dispatch", desktop="terminal"),
    CommandDef("version", "Show Catalyst version", "Info", aliases=("v",),
...
_SLACK_VIA_HERMES_ONLY = frozenset({"topup", "moa", "debug", "feedback", "egress", "init", "version", "diff", "update", "heartbeat", "refine", "review", "pause", "whoami", "platform", "insights"})
