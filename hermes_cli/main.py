...
_FORK_UPDATE_EXPORTS = {
    "_desktop_ancestor_cmdlines": "hermes_cli.main_desktop",
    "_finalize_old_macos_desktop_handoff": "hermes_cli.main_desktop",
    "COSTAS_UPDATE_BRANCH": "hermes_cli.main_install_repair",
    "_tracking_refspec": "hermes_cli.main_install_repair",
    "OFFICIAL_REPO_URL": "hermes_cli.update_cmd_git",
    "OFFICIAL_REPO_URLS": "hermes_cli.update_cmd_git",
}
...
def __getattr__(name):
    ...
    module = _FROZEN_ATTR_SOURCES.get(name) or _FORK_UPDATE_EXPORTS.get(name)
    if module is None:
