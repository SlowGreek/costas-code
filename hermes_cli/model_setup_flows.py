...
def _model_flow_azure_foundry(config, current_model=""):
    ...
    * Manual entry when every probe fails (private endpoints, etc.).
    ...
    print("Anthropic-style API endpoints.  Catalyst will probe your")
    ...
    if use_entra:
        ...
        if not has_azure_identity_installed():
            ...
            print(
                "  Catalyst will install it now (the preflight below "
...
def _model_flow_copilot_acp(config, current_model=""):
    ...
    print("  GitHub Copilot ACP delegates Catalyst turns to `copilot --acp`.")
    print("  Catalyst currently starts its own ACP subprocess for each request.")
    print("  Catalyst uses your selected model as a hint for the Copilot ACP session.")
    ...
    if provider_id == "gemini" and existing_key:
        ...
        if probe_gemini_tier is not None:
            ...
            if tier == "free":
                ...
                print(
                    "   Catalyst typically makes 3-10 API calls per user turn "
                ...
                print()
                print(
                    "   To use Gemini with Catalyst, enable billing on your "
