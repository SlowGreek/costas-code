...
def _model_flow_copilot_acp(config, current_model=""):
    ...
    _say("  GitHub Copilot ACP delegates Catalyst turns to `copilot --acp`.",
         "  Catalyst currently starts its own ACP subprocess for each request.",
         "  Catalyst uses your selected model as a hint for the Copilot ACP session.",
...
_GEMINI_FREE_TIER_NOTICE = (
    ...
    "   Catalyst typically makes 3-10 API calls per user turn (tool iterations + auxiliary tasks),",
    "   so the free tier is exhausted after a handful of messages and cannot sustain",
    "   an agent session.", "",
    "   To use Gemini with Catalyst, enable billing on your Google Cloud project and regenerate",
