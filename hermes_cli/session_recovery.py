...
_CANONICAL_TABLES = (
    "system_prompts", "sessions", "session_artifacts", "messages", "session_model_usage", "compression_locks", "gateway_routing",
    "async_delegations",
)
...
def _snapshot_and_inspect(
    ...
    try:
        ...
        if _source_fingerprint(source) != before:
            raise SessionRecoverySafetyError(
                "The source database bundle changed while it was being copied. Stop every Catalyst process using this "
                ...
                "tracking) to state.db in the background and counts as a Catalyst process even after the gateway is "
