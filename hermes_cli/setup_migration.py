...
_MIGRATION_WARNING_NOTES = (
    "  Note: OpenClaw config values may have different semantics in Catalyst.",
    "  For example, OpenClaw's tool_call_execution: \"auto\" ≠ Catalyst's yolo mode.",
...
def _print_migration_preview(report: dict):
    ...
    groups = (
        ...
        ("conflict", "  Would overwrite (conflicts with existing Catalyst config):", Colors.YELLOW,
...
def _offer_openclaw_migration(hermes_home: Path) -> bool:
    ...
    _info(f"Found OpenClaw data at {openclaw_dir}",
          "Catalyst can preview what would be imported before making any changes.", None)
