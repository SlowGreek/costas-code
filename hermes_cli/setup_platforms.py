...
def _setup_telegram():
    ...
    _info(None, "📬 Home Channel: where Catalyst delivers cron job results,",
...
def _setup_bluebubbles():
    ...
    if _declines_reconfigure("BLUEBUBBLES_SERVER_URL", "BlueBubbles", "Reconfigure BlueBubbles?"):
        return
    _info("Connects Catalyst to iMessage via BlueBubbles — a free, open-source",
...
def setup_gateway(config: dict):
    ...
    _info("Connect to messaging platforms to chat with Catalyst from anywhere.",
