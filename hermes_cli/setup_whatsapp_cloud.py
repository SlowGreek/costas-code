...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Catalyst to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Catalyst needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Catalyst gateway in another terminal:",
        "         hermes gateway", "",
