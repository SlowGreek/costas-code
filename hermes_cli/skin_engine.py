...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Catalyst"             # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " Catalyst "          # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Catalyst"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Catalyst",
            "welcome": "Welcome to Catalyst! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " Catalyst ",
            "prompt_symbol": "❯",
