...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Costas Code"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " Costas Code "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Costas Code"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Costas Code",
            "welcome": "Welcome to Costas Code! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " Costas Code ",
            "prompt_symbol": "❯",
