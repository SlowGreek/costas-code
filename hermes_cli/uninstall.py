...
def run_gui_uninstall(args):
    ...
    print()
    _print_box("│         ⚕ Catalyst Chat GUI Uninstaller                  │", Colors.MAGENTA)
    print()
...
def run_uninstall(args):
    ...
    print()
    _print_box("│            ⚕ Catalyst Uninstaller                  │", Colors.MAGENTA)
    print()
...
_REINSTALL_HINT = {
    True: "  irm https://raw.githubusercontent.com/SlowGreek/costas-code/costas-code/scripts/install.ps1 | iex",
    False: "  curl -fsSL https://raw.githubusercontent.com/SlowGreek/costas-code/costas-code/scripts/install.sh | bash"}
