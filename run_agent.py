...
from agent.interrupt_control import InterruptControlMixin, _merge_redirect_payloads, _normalize_redirect_payload
...
class AIAgent(
    ...
    def _is_copilot_url(self) -> bool:
        ...
        return any(base_url_host_matches(self._base_url_lower, h) for h in ("githubcopilot.com", "models.github.ai"))
    ...
    def _dispatch_delegate_task(self, function_args: dict) -> str:
        ...
        return _delegate_task(
            ...
            max_iterations=function_args.get("max_iterations"), role=function_args.get("role"), model=function_args.get("model"),
