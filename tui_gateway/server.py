...
# ── Fork-only helpers preserved across upstream's tui_gateway method
# extraction (methods_*.py). Upstream deleted server.py's copies of the
# methods that used these; the helpers themselves have no upstream home.
